...
export const Navigation = () => {
    ...
    return (
      <>
        <div className='h-[120px] bg-slate-50 flex justify-between px-2 py-4'>
          ...
          <div className='flex justify-between py-10'>
            ...
            <img className='block h-[30px] w-[30px] mx-2' src="https://cdn-icons-png.flaticon.com/512/7193/7193348.png" alt="price" />
          </div>
        </div>
